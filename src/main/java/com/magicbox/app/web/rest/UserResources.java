 ...
 * <p>
 * This class accesses the {@link com.magicbox.app.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
...
public class UserResources {
    ...
    public UserDTO addUser(@RequestBody User user1) {
        String serverUrl = "http://localhost:9080/auth";
        String realm = "jhipster";
        // idm-client needs to allow "Direct Access Grants: Resource Owner Password Credentials Grant"
        String clientId = "admin-cli";
        String clientSecret = "5a9610bf-6a47-46a1-9442-9e43eacd98e8";
        //  String clientSecret = "4c973896-5761-41fc-8217-07c5d13a004b" ;
        ...
        /*   UserRepresentation user = new UserRepresentation();
        user.setEnabled(true);
        user.setUsername(user1.getLogin());
