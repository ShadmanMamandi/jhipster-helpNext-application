package com.magicbox.app.service;

import com.magicbox.app.config.Constants;
import com.magicbox.app.domain.Authority;
import com.magicbox.app.domain.User;
import com.magicbox.app.repository.AuthorityRepository;
import com.magicbox.app.repository.UserRepository;
import com.magicbox.app.security.AuthoritiesConstants;
import com.magicbox.app.security.SecurityUtils;
...
public class UserService {
    ...
    public UserDTO addUser(User user) {
        ...
        userDetails.put("uid", user.getId());
        userDetails.put("sub", user.getLogin());
        userDetails.put("email", user.getEmail());
        userDetails.put("given_name", user.getFirstName());
        userDetails.put("family_name", user.getLastName());

        OAuth2AuthenticationToken oAuth2AuthenticationToken = createOAuth2AuthenticationToken(userDetails);
        return getUserFromAuthentication(oAuth2AuthenticationToken);
    }
    ...
    public OAuth2AuthenticationToken createOAuth2AuthenticationToken(Map<String, Object> userDetails) {
